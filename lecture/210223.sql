...
-- 배운 내용 : ORDER BY, 그룹함수, GROUP BY, UNION, JOIN 
...
SELECT DEPT_CODE, CASE WHEN SUBSTR(EMP_NO, 8, 1) = '1' THEN '남' ELSE '여' END AS 성별, COUNT(*) 
...
SELECT *
FROM EMPLOYEE E     
    JOIN JOB J ON E.JOB_CODE = J.`1 JOB_CODE;
...
-- EMP_NAME은 다 출력되고, DEPT_TITLE이 NULL인 하동운, 이오리도 정상적으로 출력된다. 
...
-- 부서이름 29개가 모두 출력되고, 부서에 해당하는 사람이 없는 부서의 EMP_NAME은 null로 출력된다. 
