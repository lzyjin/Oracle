...
-- 12343456YEJIN에서 YEJIN만 남기세요
SELECT LTRIM('12343456YEJIN', '12343456')
FROM DUAL;

-- 234432493487YEJIN4834927827 에서 YEJIN만 남기세요 (힌트 반환있음)
SELECT RTRIM(LTRIM('234432493487YEJIN4834927827', '234432493487'), '4834927827')
FROM DUAL;
...
SELECT TRIM('Z' FROM 'ZZZZZZYEJINZZZZZ') -- 'ZZ'이렇게 두자리 이상의 문자를 찾는것은 불가능
FROM DUAL;
...
SELECT SUBSTR('SHOWMETHEMONEY', -3, 3) -- NEY
FROM DUAL;
...
SELECT SUBSTR(EMAIL, INSTR(EMAIL, '@') +1 ) -- 산술연산 가능
FROM EMPLOYEE;
...
-- NEXT_DAY : 날짜에 입력받은 요일중 가장 가까운 요일의 날짜을 반환
